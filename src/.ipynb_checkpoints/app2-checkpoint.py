 ...
 "cells": [
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\Ishwar\\AppData\\Local\\anaconda3\\lib\\site-packages\\IPython\\core\\interactiveshell.py:3468: UserWarning: To exit: use 'exit', 'quit', or Ctrl-D.\n",
   ...
   "source": [
    ...
    "        coords_z_str = array_1.T[coords_x,coords_y]\n",
    ...
    "        coords_x = int(json.dumps(arg1[\"points\"][0][\"x\"], indent=2))\n",
    "        coords_y = int(json.dumps(arg1[\"points\"][0][\"y\"], indent=2))\n",
    "        coords_z_str = array_2.T[coords_x,coords_y]\n",
    ...
    "        coords_x = int(json.dumps(arg1[\"points\"][0][\"x\"], indent=2))\n",
    "        coords_y = int(json.dumps(arg1[\"points\"][0][\"y\"], indent=2))\n",
    "        coords_z_str = array_3.T[coords_x,coords_y]\n",
    ...
    "        coords_x = int(json.dumps(arg1[\"points\"][0][\"x\"], indent=2))\n",
    "        coords_y = int(json.dumps(arg1[\"points\"][0][\"y\"], indent=2))\n",
    "        coords_z_str = array_4.T[coords_x,coords_y]\n",
    ...
    "        coords_x = int(json.dumps(arg1[\"points\"][0][\"x\"], indent=2))\n",
    "        coords_y = int(json.dumps(arg1[\"points\"][0][\"y\"], indent=2))\n",
    "        coords_z_str = array_5.T[coords_x,coords_y]\n",
    ...
    "        coords_x = int(json.dumps(arg1[\"points\"][0][\"x\"], indent=2))\n",
    "        coords_y = int(json.dumps(arg1[\"points\"][0][\"y\"], indent=2))\n",
    "        coords_z_str = array_6.T[coords_x,coords_y]\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "'C:\\\\Users\\\\Ishwar\\\\HFH_dash_app\\\\src'"
      ]
     },
     "execution_count": 1,
     "metadata": {},
